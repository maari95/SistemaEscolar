...
<div class="container mt-5">
  ...
  <div class="card-body">
    ...
    <div class="card w-75 mb-3">
  <div class="card-body">
    <h5 class="card-title"><img src=" https://cdn3.iconfinder.com/data/icons/feather-5/24/file-plus-512.png" width="30px" height="30px">Cadastro de Aluno</h5>
   
    <p class="card-text">Redirecionar à página de cadastro de alunos.</p>
    <p class="p-0.5"></p>
    <a href="form.php" class="btn btn-outline-dark">Cadastro</a>
</div>
</div>
