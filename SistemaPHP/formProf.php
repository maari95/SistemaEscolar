...
?>
    <p class="p-2"></p>
    <form action="registrop.php" method="POST" id="formp">
        <div class="jumbotron jumbotron-fluid">
            <div class="container" style="text-align:center;">
              <h1 class="display-4;  font-effect-shadow-multiple" style="font-family:'Sofia', sans-serif; font-size: 4rem">Cadastro de Professores</h1>
    ...
    <div class="row">
        ...
        <input class="form-control form-control-sm" type="text" name="nomeProf" placeholder="Nome Professor">    
    </div> 
    <div class="col-sm-6">
        <label for="turma">Disciplina</label>
        <input class="form-control form-control-sm" type="text" name="disciplina" placeholder="Disciplina">
    </div>
